...
<html lang="en">
  ...
  <body>
                ...
                <tbody>
                  ...
                  else
                  {
                    ...
                    <tr>
                        ...
                        {
                          ?>
                            <td><a class="btn btn-dark disabled" href="set_processing.php?id=<?=$row['id']?>">Processing</a></td>
                            <td><a class="btn btn-warning" href="set_approved.php?id=<?=$row['id']?>">Approved</a></td>
                            <td><a class="btn btn-success" href="set_finished.php?id=<?=$row['id']?>">Finished</a></td>
                          <?php
                        }
                        else if($row['trip_status']=="Approved")
                        {
                          ?>
                            <td><a class="btn btn-dark disabled" href="set_processing.php?id=<?=$row['id']?>">Processing</a></td>
                            <td><a class="btn btn-dark disabled" href="set_approved.php?id=<?=$row['id']?>">Approved</a></td>
                            <td><a class="btn btn-success" href="set_finished.php?id=<?=$row['id']?>">Finished</a></td>
                          <?php
                        }
                        else if($row['trip_status']=="Finished")
                        {
                          ?>
                            <td><a class="btn btn-dark disabled" href="set_processing.php?id=<?=$row['id']?>">Processing</a></td>
                            <td><a class="btn btn-dark disabled" href="set_approved.php?id=<?=$row['id']?>">Approved</a></td>
                            <td><a class="btn btn-dark disabled" href="set_finished.php?id=<?=$row['id']?>">Finished</a></td>
                          <?php
                        }
                        ?>
    ...
    if ($status =='Appr')
    {
      ?>
      <script>
        swal("Done!", "Trip Approved Successfully!", "success");
      </script>
      <?php
    }
    if ($status =='Fin')
    {
      ?>
      <script>
        swal("Done!", "Trip Finished Successfully!", "success");
      </script>
      <?php
    }
    ?>
